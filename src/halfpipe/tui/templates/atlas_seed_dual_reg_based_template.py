...
class AtlasSeedDualRegBasedTemplate(FeatureTemplate):
    ...
    #
    #         logger.debug(
    #             f"UI->AtlasSeedDualRegBasedTemplate->on_file_panel_changed-
    #             >all_file_tags_based_on_the_current_file_patterns:\
    # {all_file_tags_based_on_the_current_file_patterns}"
    #         )
    ...
    #                     self.get_widget_by_id("file_tag_selection").
    #                     add_option(Selection(file_tag, file_tag, initial_state=True))
    #             logger.debug(
