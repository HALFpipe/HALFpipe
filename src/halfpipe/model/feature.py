...
class GradientsFeatureSchema(BaseFeatureSchema):
    ...
    # what goes here?
    # seems totally unnecessary bc all the defaults are assigned in the input spec
    # Need to be defined here bc it interacts w UI and user overwriting of things im not sure for now
    # should I put dump defaults of None here?
    # TODO cut these down/consider necessary
    n_components = fields.Int(dump_default=None, allow_none=True)
    approach = fields.Str(dump_default=None, allow_none=True)
    ...
    sparsity = fields.Float(dump_default=None, allow_none=True)
    n_iter = fields.Int(dump_default=None, allow_none=True)
